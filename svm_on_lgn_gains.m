        ...
        x_coordinate = x - 32;
         ...
         for y = 1:64
             ...
             y_coordinate = y - 32;
              ...
              gabor(x, y) = 1/(2*pi*x_std*y_std)*exp(-x_coordinate^2/(2*x_std^2) - y_coordinate^2/(2*y_std^2)) - 1/(2*pi*4*4)*exp(-x_coordinate^2/(2*4^2) - y_coordinate^2/(2*4^2));
...
save('svm_on_lgn_gains','activations');
